# Pravash — Claude Code Instructions

## Project Identity

**Pravash** (Sanskrit: journey/flow) — fluid dynamics simulation for AGNOS
...
kiran (water/smoke/fire effects), joshua (fluid simulation), impetus (fluid-body interaction)

**Note**: Built on hisab for math (FFT, spatial structures, PDE solvers).
